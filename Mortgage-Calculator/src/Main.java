...
//        from the user
        ...
        System.out.print("Principle Amount (no commas) e.g. 53000: ");
        ...
        expectedMonthlyPaymentAmount = principleAmount * ((monthlyInterestRate * Math.pow((1 + monthlyInterestRate), numberOfPayments) / (Math.pow( (1+monthlyInterestRate), numberOfPayments) - 1)));
...
//        interest paid
        ...
        // DISPLAY OUTPUT
        double totalInterestPaid = (numberOfPayments * expectedMonthlyPaymentAmount) - principleAmount;
